...
if __name__ == "__main__":
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # MUST BE RUN IN INTERACTIVE ENVIRONMENT
    # RUNNING FROM COMMAND LINE IS FINE
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    print("\n--- STEP 2: Load Science Data Stack & Crop to Calibration Region ---")
    raw_stack = load_fits(FITS_DATA_FOLDER, logger=logger)

    # Crop full stack by primary calibration bounds
