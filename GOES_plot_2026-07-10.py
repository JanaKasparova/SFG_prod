...
if __name__ == "__main__":
    ...
    # -----------------------------------------------------------------
    # --- Directory Paths ---
    DIR_SLITJAW = "sfg/2026-07-10-C6.0/sun_area/SlitJaw"
    DIR_HDF_DATA = "sfg/2026-07-10-C6.0/sun_area"
    DIR_PLOTS = "Plots/2026-07-10"
    ...
    REF_XMIN, REF_XMAX = 246, 427
    REF_YMIN, REF_YMAX = 328, 502
    ...
    plot_spectrum_at_time(
        mC=mC,
        mD=mD,
        target_time=my_target_time + u.s * 50,
